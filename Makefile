...
deploy-sepolia :
	@forge script script/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEPOLIA_RPC_URL) --account mymetamask --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvvv
