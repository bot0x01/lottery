 ...
 * @author bot0x01
 * @notice A Simple Raffle Smart Contract lottery
...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    constructor(
        ...
        i_interval = interval; // Duration of lottery in seconds
        i_keyHash = gasLane;
    ...
    function performUpkeep(bytes calldata /* performData */) external {
        // check to see if enough time ahs passed
